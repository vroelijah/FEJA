...
document.body.appendChild(buttonContainer);
  ...
  if (!hasStudyPageBeenCreated) {
    ...
    const buttons = [
      { label: "North Reading Room", color: "red" },
      { label: "Central Raeding Room", color: "red" },
      { label: "Galleria", color: "red" },
      { label: "Music Library", color: "red" },
      { label: "Main Stacks", color: "red" },
    ];
